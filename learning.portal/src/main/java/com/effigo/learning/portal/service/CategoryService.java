...
public class CategoryService {
	...
	public boolean isUserAuthorizedToUpdateCategory(Long userId, Long categoryId) {

		Optional<CategoryEntity> categoryOptional = categoryRepository.findById(categoryId);
		if (categoryOptional.isPresent()) {
			CategoryEntity category = categoryOptional.get();

			return category.getAuthorId().equals(userId);
		}
		return false;
	}
	...
	public boolean isUserAuthorizedToSaveCategory(Long userId, Long categoryId) {
