...
public class CourseController {
    ...
    @GetMapping("/categories/{category_Id}/courses")
	//for getting the list of courses under a category
    public  List<CourseEntity> findByCategoryId(@PathVariable Long category_Id) {
        return courseService.findByCategoryId(category_Id);
    }
